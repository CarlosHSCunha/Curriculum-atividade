...
function Header() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-background/70 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto max-w-6xl flex items-center justify-between px-6 py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "font-semibold tracking-tight text-foreground hover:text-primary transition-colors", children: [
      "Carlos Henrique",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex items-center gap-1 sm:gap-2", children: navLinks.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: l.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-background/60 mt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Carlos Henrique da Silva Cunha"
    ] }),
...
const appCss = "/assets/styles-BnNeRfRz.css";
...
const $$splitComponentImporter$4 = () => import("./sobre-DhwCdySi.js");
const Route$4 = createFileRoute("/sobre")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Biografia, foco em cloud (AWS) e criação de produtos digitais do Figma ao código."
    }, {
      property: "og:title",
      content: "Sobre — Carlos Henrique"
    }, {
      property: "og:description",
      content: "Biografia e stack utilizada neste portfólio."
    }]
  })
});
const $$splitComponentImporter$3 = () => import("./projetos-DI6uFYxd.js");
const Route$3 = createFileRoute("/projetos")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Repositórios do GitHub e projetos conceituais de UX/UI."
    }, {
      property: "og:title",
      content: "Projetos — Carlos Henrique"
    }, {
      property: "og:description",
      content: "Código e design: do GitHub aos estudos de caso."
    }]
  })
});
const $$splitComponentImporter$2 = () => import("./profissional-DMmJqmVj.js");
const Route$2 = createFileRoute("/profissional")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Atuação como Estagiário em Desenvolvimento Fullstack e UX/UI Design."
    }, {
      property: "og:title",
      content: "Experiência Profissional — Carlos Henrique"
    }, {
      property: "og:description",
      content: "React.js, Python, HTML5, CSS3, JavaScript e Figma."
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./academica-BPz3Wyzh.js");
const Route$1 = createFileRoute("/academica")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Graduação, formação em cloud computing (AWS) e técnico em comunicação visual."
    }, {
      property: "og:title",
      content: "Formação Acadêmica — Carlos Henrique"
    }, {
      property: "og:description",
      content: "Trajetória acadêmica de Carlos Henrique."
    }]
  })
});
const $$splitComponentImporter = () => import("./index-CHh03r4w.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfólio de Carlos Henrique da Silva Cunha, Desenvolvedor Fullstack e Estagiário em UX/UI Design."
    }, {
      property: "og:title",
      content: "Carlos Henrique — Fullstack & UX/UI"
    }, {
      property: "og:description",
      content: "Interfaces centradas no usuário, do Figma ao código."
    }]
  })
});
const SobreRoute = Route$4.update({
  id: "/sobre",
  path: "/sobre",
  getParentRoute: () => Route$5
});
const ProjetosRoute = Route$3.update({
  id: "/projetos",
  path: "/projetos",
  getParentRoute: () => Route$5
});
const ProfissionalRoute = Route$2.update({
  id: "/profissional",
  path: "/profissional",
  getParentRoute: () => Route$5
});
const AcademicaRoute = Route$1.update({
  id: "/academica",
  path: "/academica",
  getParentRoute: () => Route$5
});
