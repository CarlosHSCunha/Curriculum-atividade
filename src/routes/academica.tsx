...
export const Route = createFileRoute("/academica")({
  component: Academica,
  head: () => ({
    meta: [
      { title: "Formação Acadêmica — Carlos Henrique" },
      { name: "description", content: "Graduação, formação em cloud computing (AWS) e técnico em comunicação visual." },
      { property: "og:title", content: "Formação Acadêmica — Carlos Henrique" },
      { property: "og:description", content: "Trajetória acadêmica de Carlos Henrique." },
    ],
  }),
});
