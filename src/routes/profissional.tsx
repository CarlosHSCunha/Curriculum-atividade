...
export const Route = createFileRoute("/profissional")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Atuação como Estagiário em Desenvolvimento Fullstack e UX/UI Design." },
      { property: "og:title", content: "Experiência Profissional — Carlos Henrique" },
      { property: "og:description", content: "React.js, Python, HTML5, CSS3, JavaScript e Figma." },
    ],
  }),
});
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              ...
              Trabalho em conjunto com equipes para transformar requisitos em soluções funcionais,
              acessíveis e visualmente consistentes.
            </p>
