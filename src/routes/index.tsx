...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfólio de Carlos Henrique da Silva Cunha, Desenvolvedor Fullstack e Estagiário em UX/UI Design." },
      { property: "og:title", content: "Carlos Henrique — Fullstack & UX/UI" },
      { property: "og:description", content: "Interfaces centradas no usuário, do Figma ao código." },
    ],
  }),
});
...
function Index() {
  return (
    <section className="mx-auto max-w-6xl px-6 pt-28 sm:pt-32 pb-20 grid md:grid-cols-2 gap-10 md:gap-12 items-center">
      <div>
        <p className="text-primary text-xs sm:text-sm uppercase tracking-[0.25em] mb-4">Portfólio · Carlos Henrique</p>
        ...
        <p className="mt-6 text-base text-muted-foreground max-w-md leading-relaxed">
          Olá! Sou apaixonado por construir produtos digitais que unem código limpo e
          design intencional. Meu foco está em criar interfaces centradas no usuário,
          acessíveis e que entreguem valor real do primeiro clique ao último.
        </p>
